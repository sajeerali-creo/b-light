...
function GetPaymentGatewayDetails($data) {
    return apiRequest('PaymentGateway/GetPaymentGatewayDetails', 'GET', $data);
}

function SavePaymentDetails($data) {
    return apiRequest('ClientSubscription/SavePaymentDetails', 'POST', $data);
}
function SaveBankRequestLog($data) {
    return apiRequest('PaymentGateway/SaveBankRequestLog', 'POST', $data);
}

function GetClientNewSubscriptionId($data) {
    return apiRequest('ClientSubscription/GetClientNewSubscriptionId', 'GET', $data);
}

function GenerateInvoiceReceiptAgainstSubscription($data) {
    return apiRequest('ClientSubscription/GenerateInvoiceReceiptAgainstSubscription', 'POST', $data);
}
