...
<section class="hero-video" role="banner" aria-label="Hero video banner">
    ...
    <div class="hero-content">
        ...
        <p class="hero-sub">Your journey to a healthier lifestyle starts here—fresh, flavorful, and tailored just for
...
<!-- <section class="d-flex justify-content-center align-items-center" style="height:70px; background-color: #bfc726;">

    <img src="img/ride-main.gif" alt="" style="height:70px; object-fit: contain; width: 100%;">

</section> -->

<section class="d-flex justify-content-center align-items-center animation" style="height:70px; overflow: hidden; background-color: #bfc726; background-image: url(img/bg-citi.webp); background-size: cover;

    background-position: center;">

    <div id="lottie-animation" style="width:1920px; height:68px; margin:auto;"></div>
...
$half = ceil(count($logos) / 2);

$row1 = array_slice($logos, 0, $half);

$row2 = array_slice($logos, $half);
...
<section class="padding-bottom padding-top bg-client">
    ...
    <div class="container">
        ...
        <div class="logo-slider-wrapper">
                ...
                <div class="logo-track">
                    ...
                    <?php foreach ($row1 as $logo) { ?>
                        ...
                        <div class="logo-item">
                            ...
                            <img src="<?php echo ADMIN_URL . $logo['file_path']; ?>" alt="Client Logo">
            ...
            <div class="logo-slider-row reverse">
                    ...
                    <div class="testibox p-4 p-lg-5">
                        ...
                        <div class="d-flex gap-2 mt-4 align-items-center">
                            ...
                            <div class="details">
                                ...
                                <h5 class="m-0"><?php echo $result['message_from']; ?></h5>
