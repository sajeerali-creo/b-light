...
$data = [
    "Registration" => [
        "Currency" => "AED",
        "ReturnPath" => "https://srv1105086.hstgr.cloud/contact.php",
...
$dietitian_emails = [
    "Kiram El Tbayli" => "kiram@example.com",
    "Marisa Bousaba"  => "arisabousaba@example.com",
    "Mireille Ahmad"  => "ireillahmad@example.com",
    "Nermin Makhoul"  => "nermin@example.com",
    "Sara Obeid"      => "sara@example.com",
    "Eman Baker"      => "eman@example.com",
];
...
if (isset($_POST["submit"]) && $_POST["submit"] == "contactform") {
    ...
    $selected_dietitian = $_POST['dietitian'] ?? '';
    $dietitian_email    = $dietitian_emails[$selected_dietitian] ?? '';

    if (empty($errors)) {
        $full_name = $FirstName . ' ' . $LastName;
        //$sql ="INSERT INTO message set 'full_name'= $FirstName.' '.$LastName, 'email'= $EmailId, 'contact'= $MobileNumber, 'message'= $Message";
        $sql = "INSERT INTO messages (full_name, email, contact, message, dietitian_name) VALUES ('$full_name', '$EmailId', '$MobileNumber', '$Message', '$selected_dietitian')";
        $query = mysqli_query($connection, $sql);

        if ($dietitian_email) {
            $subject = "New Inquiery from $FirstName $LastName";
            $body = "
            ...
            $result = sendEmail($dietitian_email, $selected_dietitian, $subject, $body);
    ...
    <div class="container">
        ...
        <div class="row justify-content-between flex-column-reverse flex-lg-row">
                ...
                <form method="POST" id="contactForm">
                    ...
                    <div class="row contact-form">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <select class="form-select form-control w-100" name="dietitian" id="dietitian" required>
                                <option value="">Select Dietitian</option>
                            <?php foreach ($dietitian_emails as $name => $email): ?>
                                <option value="<?= htmlspecialchars($name) ?>" 
                                    <?= ($selected_dietitian == $name) ? 'selected' : '' ?>>
            ...
            <div class="col-lg-6">
                ...
                <img src="img/contact-img.jpg" class="w-100 mb-4 mb-lg-0 all-imag-height" alt="">
