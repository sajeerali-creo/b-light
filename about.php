                ...
                foreach ($gallery_list as $item) {
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4" data-aos="fade-up" bis_skin_checked="1">
                        ...
                        <a href="#" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
                            ...
                            data-url="<?= ROOT_URL ?>contact.php?dietitian=<?= urlencode($name) ?>">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body d-flex flex-column align-items-center">
            ...
            <div class="d-flex justify-content-center mt-5 w-100 d-flex justify-content-center">
                ...
                <a href="<?= ROOT_URL ?>contact.php" class="btn btn-primary w-100 d-flex justify-content-center bg-lime-button bookAppBtn">Book Dietitian Now</a>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        offcanvasRight.addEventListener('show.bs.offcanvas', function (event) {
            ...
            if (trigger) {
                ...
                var newUrl = trigger.getAttribute('data-url'); // get dynamic url

                // Update book button href
                var bookBtn = offcanvasRight.querySelector('.bookAppBtn');
                if (bookBtn && newUrl) {
                    bookBtn.setAttribute('href', newUrl);
                }
...
<section class="padding-bottom padding-top bg-stories" id="success">
